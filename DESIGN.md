...
这台仪器应当贯穿整页：用户向下滚动时，连续柔噪光场、校准轨道、档案编号与显影刻度持续出现。首屏罗盘是清晰的机械焦点，后续章节像同一片时间光场里的不同观察面。背景保持抽象、意识流和低对比，真实产品截图承担具体叙事。

## Aesthetic Direction

- **Direction:** Soft-noise Optical Chronofuturism / 柔噪光学时间未来主义。
- **Decoration level:** 有主次的表达性材质，产品与数据区域保持克制。
- **Mood:** 温和、安静、精确、长期可信。
- **Layout:** 编辑式非对称档案 + 机械校准网格 + 开放式产品舞台。
- **Visual signature:** 蓝、粉、米黄与海沫绿组成一片连续的柔噪时间光场，从 Hero 漂移到页脚；机械文字与产品截图保持清晰锐利。
